...
class EditPlaylistFragment : CreatePlaylistFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.CrPLBackArrowImage.setOnClickListener { backHandle() }
        ...
        binding.CrPLHeadTextBar.text = getString(R.string.edpl_edit)
        binding.CrPlCreateButton.text = getString(R.string.edpl_save_button_text)
    ...
    private fun backHandle() {
        findNavController().navigate(R.id.action_editPlaylistFragment_to_playlistInfoFragment,
